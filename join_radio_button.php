...
② “몰”이 제3자에게 구매자 개인정보를 제공?위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유?이용 기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.</p>
				...
				<p>이용약관에 동의하십니까?</p>
				<input type="radio" name="join_radio" value="ok" checked="checked">동의함
				<input type="radio" name="join_radio" value="no">동의안함
			</div>
			<div class="join_box" style="border-top: 0px solid #000;">
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
				...
				<input type="radio" name="join_radio2" value="ok" checked="checked">동의함
				<input type="radio" name="join_radio2" value="no">동의안함
			</div>
		</div>
	</body>
</html>